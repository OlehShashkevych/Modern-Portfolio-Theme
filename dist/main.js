...
}`,Tf=[new k(1,0,0),new k(-1,0,0),new k(0,1,0),new k(0,-1,0),new k(0,0,1),new k(0,0,-1)],yf=[new k(0,-1,0),new k(0,-1,0),new k(0,0,1),new k(0,0,-1),new k(0,-1,0),new k(0,-1,0)],js=new lt,si=new k,Lr=new k;function bf(n,e,t){let i=new Ta;const r=new qe,s=new qe,a=new st,o=new Oo,l=new Bo,c={},d=t.maxTextureSize,f={0:1,1:0,2:2},u=new Zt({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new qe},radius:{value:4}},vertexShader:Mf,fragmentShader:Ef}),g=u.clone();g.defines.HORIZONTAL_PASS=1;const m=new Ot;m.setAttribute("position",new Lt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const x=new ln(m,u),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=1;let h=this.type;this.render=function(y,R,_){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||y.length===0)return;this.type===2&&(Le("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=1);const E=n.getRenderTarget(),L=n.getActiveCubeFace(),C=n.getActiveMipmapLevel(),F=n.state;F.setBlending(0),F.buffers.depth.getReversed()===!0?F.buffers.color.setClear(0,0,0,0):F.buffers.color.setClear(1,1,1,1),F.buffers.depth.setTest(!0),F.setScissorTest(!1);const I=h!==this.type;I&&R.traverse(function(N){N.material&&(Array.isArray(N.material)?N.material.forEach(D=>D.needsUpdate=!0):N.material.needsUpdate=!0)});for(let N=0,D=y.length;N<D;N++){const z=y[N],P=z.shadow;if(P===void 0){Le("WebGLShadowMap:",z,"has no shadow.");continue}if(P.autoUpdate===!1&&P.needsUpdate===!1)continue;r.copy(P.mapSize);const q=P.getFrameExtents();r.multiply(q),s.copy(P.mapSize),(r.x>d||r.y>d)&&(r.x>d&&(s.x=Math.floor(d/q.x),r.x=s.x*q.x,P.mapSize.x=s.x),r.y>d&&(s.y=Math.floor(d/q.y),r.y=s.y*q.y,P.mapSize.y=s.y));const K=n.state.buffers.depth.getReversed();if(P.camera._reversedDepth=K,P.map===null||I===!0){if(P.map!==null&&(P.map.depthTexture!==null&&(P.map.depthTexture.dispose(),P.map.depthTexture=null),P.map.dispose()),this.type===3){if(z.isPointLight){Le("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}P.map=new Kt(r.x,r.y,{format:1030,type:1016,minFilter:1006,magFilter:1006,generateMipmaps:!1}),P.map.texture.name=z.name+".shadowMap",P.map.depthTexture=new Kn(r.x,r.y,1015),P.map.depthTexture.name=z.name+".shadowMapDepth",P.map.depthTexture.format=1026,P.map.depthTexture.compareFunction=null,P.map.depthTexture.minFilter=1003,P.map.depthTexture.magFilter=1003}else z.isPointLight?(P.map=new Ia(r.x),P.map.depthTexture=new Lo(r.x,1014)):(P.map=new Kt(r.x,r.y),P.map.depthTexture=new Kn(r.x,r.y,1014)),P.map.depthTexture.name=z.name+".shadowMap",P.map.depthTexture.format=1026,this.type===1?(P.map.depthTexture.compareFunction=K?518:515,P.map.depthTexture.minFilter=1006,P.map.depthTexture.magFilter=1006):(P.map.depthTexture.compareFunction=null,P.map.depthTexture.minFilter=1003,P.map.depthTexture.magFilter=1003);P.camera.updateProjectionMatrix()}const ee=P.map.isWebGLCubeRenderTarget?6:1;for(let ne=0;ne<ee;ne++){if(P.map.isWebGLCubeRenderTarget)n.setRenderTarget(P.map,ne),n.clear();else{ne===0&&(n.setRenderTarget(P.map),n.clear());const se=P.getViewport(ne);a.set(s.x*se.x,s.y*se.y,s.x*se.z,s.y*se.w),F.viewport(a)}if(z.isPointLight){const se=P.camera,ge=P.matrix,Ee=z.distance||se.far;Ee!==se.far&&(se.far=Ee,se.updateProjectionMatrix()),si.setFromMatrixPosition(z.matrixWorld),se.position.copy(si),Lr.copy(se.position),Lr.add(Tf[ne]),se.up.copy(yf[ne]),se.lookAt(Lr),se.updateMatrixWorld(),ge.makeTranslation(-si.x,-si.y,-si.z),js.multiplyMatrices(se.projectionMatrix,se.matrixWorldInverse),P._frustum.setFromProjectionMatrix(js,se.coordinateSystem,se.reversedDepth)}else P.updateMatrices(z);i=P.getFrustum(),S(R,_,P.camera,z,this.type)}P.isPointLightShadow!==!0&&this.type===3&&b(P,_),P.needsUpdate=!1}h=this.type,p.needsUpdate=!1,n.setRenderTarget(E,L,C)};function b(y,R){const _=e.update(x);u.defines.VSM_SAMPLES!==y.blurSamples&&(u.defines.VSM_SAMPLES=y.blurSamples,g.defines.VSM_SAMPLES=y.blurSamples,u.needsUpdate=!0,g.needsUpdate=!0),y.mapPass===null&&(y.mapPass=new Kt(r.x,r.y,{format:1030,type:1016})),u.uniforms.shadow_pass.value=y.map.depthTexture,u.uniforms.resolution.value=y.mapSize,u.uniforms.radius.value=y.radius,n.setRenderTarget(y.mapPass),n.clear(),n.renderBufferDirect(R,null,_,u,x,null),g.uniforms.shadow_pass.value=y.mapPass.texture,g.uniforms.resolution.value=y.mapSize,g.uniforms.radius.value=y.radius,n.setRenderTarget(y.map),n.clear(),n.renderBufferDirect(R,null,_,g,x,null)}function w(y,R,_,E){let L=null;const C=_.isPointLight===!0?y.customDistanceMaterial:y.customDepthMaterial;if(C!==void 0)L=C;else if(L=_.isPointLight===!0?l:o,n.localClippingEnabled&&R.clipShadows===!0&&Array.isArray(R.clippingPlanes)&&R.clippingPlanes.length!==0||R.displacementMap&&R.displacementScale!==0||R.alphaMap&&R.alphaTest>0||R.map&&R.alphaTest>0||R.alphaToCoverage===!0){const F=L.uuid,I=R.uuid;let N=c[F];N===void 0&&(N={},c[F]=N);let D=N[I];D===void 0&&(D=L.clone(),N[I]=D,R.addEventListener("dispose",T)),L=D}if(L.visible=R.visible,L.wireframe=R.wireframe,E===3?L.side=R.shadowSide!==null?R.shadowSide:R.side:L.side=R.shadowSide!==null?R.shadowSide:f[R.side],L.alphaMap=R.alphaMap,L.alphaTest=R.alphaToCoverage===!0?.5:R.alphaTest,L.map=R.map,L.clipShadows=R.clipShadows,L.clippingPlanes=R.clippingPlanes,L.clipIntersection=R.clipIntersection,L.displacementMap=R.displacementMap,L.displacementScale=R.displacementScale,L.displacementBias=R.displacementBias,L.wireframeLinewidth=R.wireframeLinewidth,L.linewidth=R.linewidth,_.isPointLight===!0&&L.isMeshDistanceMaterial===!0){const F=n.properties.get(L);F.light=_}return L}function S(y,R,_,E,L){if(y.visible===!1)return;if(y.layers.test(R.layers)&&(y.isMesh||y.isLine||y.isPoints)&&(y.castShadow||y.receiveShadow&&L===3)&&(!y.frustumCulled||i.intersectsObject(y))){y.modelViewMatrix.multiplyMatrices(_.matrixWorldInverse,y.matrixWorld);const I=e.update(y),N=y.material;if(Array.isArray(N)){const D=I.groups;for(let z=0,P=D.length;z<P;z++){const q=D[z],K=N[q.materialIndex];if(K&&K.visible){const ee=w(y,K,E,L);y.onBeforeShadow(n,y,R,_,I,ee,q),n.renderBufferDirect(_,null,I,ee,y,q),y.onAfterShadow(n,y,R,_,I,ee,q)}}}else if(N.visible){const D=w(y,N,E,L);y.onBeforeShadow(n,y,R,_,I,D,null),n.renderBufferDirect(_,null,I,D,y,null),y.onAfterShadow(n,y,R,_,I,D,null)}}const F=y.children;for(let I=0,N=F.length;I<N;I++)S(F[I],R,_,E,L)}function T(y){y.target.removeEventListener("dispose",T);for(const _ in c){const E=c[_],L=y.target.uuid;L in E&&(E[L].dispose(),delete E[L])}}}function Af(n,e){function t(){let U=!1;const ae=new st;let J=null;const de=new st(0,0,0,0);return{setMask:function(me){J!==me&&!U&&(n.colorMask(me,me,me,me),J=me)},setLocked:function(me){U=me},setClear:function(me,j,Me,xe,it){it===!0&&(me*=xe,j*=xe,Me*=xe),ae.set(me,j,Me,xe),de.equals(ae)===!1&&(n.clearColor(me,j,Me,xe),de.copy(ae))},reset:function(){U=!1,J=null,de.set(-1,0,0,0)}}}function i(){let U=!1,ae=!1,J=null,de=null,me=null;return{setReversed:function(j){if(ae!==j){const Me=e.get("EXT_clip_control");j?Me.clipControlEXT(Me.LOWER_LEFT_EXT,Me.ZERO_TO_ONE_EXT):Me.clipControlEXT(Me.LOWER_LEFT_EXT,Me.NEGATIVE_ONE_TO_ONE_EXT),ae=j;const xe=me;me=null,this.setClear(xe)}},getReversed:function(){return ae},setTest:function(j){j?te(n.DEPTH_TEST):Pe(n.DEPTH_TEST)},setMask:function(j){J!==j&&!U&&(n.depthMask(j),J=j)},setFunc:function(j){if(ae&&(j=ao[j]),de!==j){switch(j){case 0:n.depthFunc(n.NEVER);break;case 1:n.depthFunc(n.ALWAYS);break;case 2:n.depthFunc(n.LESS);break;case 3:n.depthFunc(n.LEQUAL);break;case 4:n.depthFunc(n.EQUAL);break;case 5:n.depthFunc(n.GEQUAL);break;case 6:n.depthFunc(n.GREATER);break;case 7:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}de=j}},setLocked:function(j){U=j},setClear:function(j){me!==j&&(me=j,ae&&(j=1-j),n.clearDepth(j))},reset:function(){U=!1,J=null,de=null,me=null,ae=!1}}}function r(){let U=!1,ae=null,J=null,de=null,me=null,j=null,Me=null,xe=null,it=null;return{setTest:function(et){U||(et?te(n.STENCIL_TEST):Pe(n.STENCIL_TEST))},setMask:function(et){ae!==et&&!U&&(n.stencilMask(et),ae=et)},setFunc:function(et,Ht,kt){(J!==et||de!==Ht||me!==kt)&&(n.stencilFunc(et,Ht,kt),J=et,de=Ht,me=kt)},setOp:function(et,Ht,kt){(j!==et||Me!==Ht||xe!==kt)&&(n.stencilOp(et,Ht,kt),j=et,Me=Ht,xe=kt)},setLocked:function(et){U=et},setClear:function(et){it!==et&&(n.clearStencil(et),it=et)},reset:function(){U=!1,ae=null,J=null,de=null,me=null,j=null,Me=null,xe=null,it=null}}}const s=new t,a=new i,o=new r,l=new WeakMap,c=new WeakMap;let d={},f={},u={},g=new WeakMap,m=[],x=null,p=!1,h=null,b=null,w=null,S=null,T=null,y=null,R=null,_=new Ge(0,0,0),E=0,L=!1,C=null,F=null,I=null,N=null,D=null;const z=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let P=!1,q=0;const K=n.getParameter(n.VERSION);K.indexOf("WebGL")!==-1?(q=parseFloat(/^WebGL (\d)/.exec(K)[1]),P=q>=1):K.indexOf("OpenGL ES")!==-1&&(q=parseFloat(/^OpenGL ES (\d)/.exec(K)[1]),P=q>=2);let ee=null,ne={};const se=n.getParameter(n.SCISSOR_BOX),ge=n.getParameter(n.VIEWPORT),Ee=new st().fromArray(se),Re=new st().fromArray(ge);function Y(U,ae,J,de){const me=new Uint8Array(4),j=n.createTexture();n.bindTexture(U,j),n.texParameteri(U,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(U,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let Me=0;Me<J;Me++)U===n.TEXTURE_3D||U===n.TEXTURE_2D_ARRAY?n.texImage3D(ae,0,n.RGBA,1,1,de,0,n.RGBA,n.UNSIGNED_BYTE,me):n.texImage2D(ae+Me,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,me);return j}const re={};re[n.TEXTURE_2D]=Y(n.TEXTURE_2D,n.TEXTURE_2D,1),re[n.TEXTURE_CUBE_MAP]=Y(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),re[n.TEXTURE_2D_ARRAY]=Y(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),re[n.TEXTURE_3D]=Y(n.TEXTURE_3D,n.TEXTURE_3D,1,1),s.setClear(0,0,0,1),a.setClear(1),o.setClear(0),te(n.DEPTH_TEST),a.setFunc(3),ct(!1),ft(1),te(n.CULL_FACE),He(0);function te(U){d[U]!==!0&&(n.enable(U),d[U]=!0)}function Pe(U){d[U]!==!1&&(n.disable(U),d[U]=!1)}function De(U,ae){return u[U]!==ae?(n.bindFramebuffer(U,ae),u[U]=ae,U===n.DRAW_FRAMEBUFFER&&(u[n.FRAMEBUFFER]=ae),U===n.FRAMEBUFFER&&(u[n.DRAW_FRAMEBUFFER]=ae),!0):!1}function Ae(U,ae){let J=m,de=!1;if(U){J=g.get(ae),J===void 0&&(J=[],g.set(ae,J));const me=U.textures;if(J.length!==me.length||J[0]!==n.COLOR_ATTACHMENT0){for(let j=0,Me=me.length;j<Me;j++)J[j]=n.COLOR_ATTACHMENT0+j;J.length=me.length,de=!0}}else J[0]!==n.BACK&&(J[0]=n.BACK,de=!0);de&&n.drawBuffers(J)}function Je(U){return x!==U?(n.useProgram(U),x=U,!0):!1}const Oe={100:n.FUNC_ADD,101:n.FUNC_SUBTRACT,102:n.FUNC_REVERSE_SUBTRACT};Oe[103]=n.MIN,Oe[104]=n.MAX;const Ye={200:n.ZERO,201:n.ONE,202:n.SRC_COLOR,204:n.SRC_ALPHA,210:n.SRC_ALPHA_SATURATE,208:n.DST_COLOR,206:n.DST_ALPHA,203:n.ONE_MINUS_SRC_COLOR,205:n.ONE_MINUS_SRC_ALPHA,209:n.ONE_MINUS_DST_COLOR,207:n.ONE_MINUS_DST_ALPHA,211:n.CONSTANT_COLOR,212:n.ONE_MINUS_CONSTANT_COLOR,213:n.CONSTANT_ALPHA,214:n.ONE_MINUS_CONSTANT_ALPHA};function He(U,ae,J,de,me,j,Me,xe,it,et){if(U===0){p===!0&&(Pe(n.BLEND),p=!1);return}if(p===!1&&(te(n.BLEND),p=!0),U!==5){if(U!==h||et!==L){if((b!==100||T!==100)&&(n.blendEquation(n.FUNC_ADD),b=100,T=100),et)switch(U){case 1:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case 2:n.blendFunc(n.ONE,n.ONE);break;case 3:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case 4:n.blendFuncSeparate(n.DST_COLOR,n.ONE_MINUS_SRC_ALPHA,n.ZERO,n.ONE);break;default:Xe("WebGLState: Invalid blending: ",U);break}else switch(U){case 1:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case 2:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE,n.ONE,n.ONE);break;case 3:Xe("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case 4:Xe("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Xe("WebGLState: Invalid blending: ",U);break}w=null,S=null,y=null,R=null,_.set(0,0,0),E=0,h=U,L=et}return}me=me||ae,j=j||J,Me=Me||de,(ae!==b||me!==T)&&(n.blendEquationSeparate(Oe[ae],Oe[me]),b=ae,T=me),(J!==w||de!==S||j!==y||Me!==R)&&(n.blendFuncSeparate(Ye[J],Ye[de],Ye[j],Ye[Me]),w=J,S=de,y=j,R=Me),(xe.equals(_)===!1||it!==E)&&(n.blendColor(xe.r,xe.g,xe.b,it),_.copy(xe),E=it),h=U,L=!1}function ke(U,ae){U.side===2?Pe(n.CULL_FACE):te(n.CULL_FACE);let J=U.side===1;ae&&(J=!J),ct(J),U.blending===1&&U.transparent===!1?He(0):He(U.blending,U.blendEquation,U.blendSrc,U.blendDst,U.blendEquationAlpha,U.blendSrcAlpha,U.blendDstAlpha,U.blendColor,U.blendAlpha,U.premultipliedAlpha),a.setFunc(U.depthFunc),a.setTest(U.depthTest),a.setMask(U.depthWrite),s.setMask(U.colorWrite);const de=U.stencilWrite;o.setTest(de),de&&(o.setMask(U.stencilWriteMask),o.setFunc(U.stencilFunc,U.stencilRef,U.stencilFuncMask),o.setOp(U.stencilFail,U.stencilZFail,U.stencilZPass)),_t(U.polygonOffset,U.polygonOffsetFactor,U.polygonOffsetUnits),U.alphaToCoverage===!0?te(n.SAMPLE_ALPHA_TO_COVERAGE):Pe(n.SAMPLE_ALPHA_TO_COVERAGE)}function ct(U){C!==U&&(U?n.frontFace(n.CW):n.frontFace(n.CCW),C=U)}function ft(U){U!==0?(te(n.CULL_FACE),U!==F&&(U===1?n.cullFace(n.BACK):U===2?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):Pe(n.CULL_FACE),F=U}function mt(U){U!==I&&(P&&n.lineWidth(U),I=U)}function _t(U,ae,J){U?(te(n.POLYGON_OFFSET_FILL),(N!==ae||D!==J)&&(N=ae,D=J,a.getReversed()&&(ae=-ae),n.polygonOffset(ae,J))):Pe(n.POLYGON_OFFSET_FILL)}function nt(U){U?te(n.SCISSOR_TEST):Pe(n.SCISSOR_TEST)}function dt(U){U===void 0&&(U=n.TEXTURE0+z-1),ee!==U&&(n.activeTexture(U),ee=U)}function O(U,ae,J){J===void 0&&(ee===null?J=n.TEXTURE0+z-1:J=ee);let de=ne[J];de===void 0&&(de={type:void 0,texture:void 0},ne[J]=de),(de.type!==U||de.texture!==ae)&&(ee!==J&&(n.activeTexture(J),ee=J),n.bindTexture(U,ae||re[U]),de.type=U,de.texture=ae)}function Tt(){const U=ne[ee];U!==void 0&&U.type!==void 0&&(n.bindTexture(U.type,null),U.type=void 0,U.texture=void 0)}function $e(){try{n.compressedTexImage2D(...arguments)}catch(U){Xe("WebGLState:",U)}}function A(){try{n.compressedTexImage3D(...arguments)}catch(U){Xe("WebGLState:",U)}}function v(){try{n.texSubImage2D(...arguments)}catch(U){Xe("WebGLState:",U)}}function G(){try{n.texSubImage3D(...arguments)}catch(U){Xe("WebGLState:",U)}}function W(){try{n.compressedTexSubImage2D(...arguments)}catch(U){Xe("WebGLState:",U)}}function $(){try{n.compressedTexSubImage3D(...arguments)}catch(U){Xe("WebGLState:",U)}}function ie(){try{n.texStorage2D(...arguments)}catch(U){Xe("WebGLState:",U)}}function oe(){try{n.texStorage3D(...arguments)}catch(U){Xe("WebGLState:",U)}}function Z(){try{n.texImage2D(...arguments)}catch(U){Xe("WebGLState:",U)}}function Q(){try{n.texImage3D(...arguments)}catch(U){Xe("WebGLState:",U)}}function le(U){return f[U]!==void 0?f[U]:n.getParameter(U)}function Te(U,ae){f[U]!==ae&&(n.pixelStorei(U,ae),f[U]=ae)}function ue(U){Ee.equals(U)===!1&&(n.scissor(U.x,U.y,U.z,U.w),Ee.copy(U))}function ce(U){Re.equals(U)===!1&&(n.viewport(U.x,U.y,U.z,U.w),Re.copy(U))}function we(U,ae){let J=c.get(ae);J===void 0&&(J=new WeakMap,c.set(ae,J));let de=J.get(U);de===void 0&&(de=n.getUniformBlockIndex(ae,U.name),J.set(U,de))}function Ce(U,ae){const de=c.get(ae).get(U);l.get(ae)!==de&&(n.uniformBlockBinding(ae,de,U.__bindingPointIndex),l.set(ae,de))}function Fe(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),a.setReversed(!1),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),n.pixelStorei(n.PACK_ALIGNMENT,4),n.pixelStorei(n.UNPACK_ALIGNMENT,4),n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,!1),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,n.BROWSER_DEFAULT_WEBGL),n.pixelStorei(n.PACK_ROW_LENGTH,0),n.pixelStorei(n.PACK_SKIP_PIXELS,0),n.pixelStorei(n.PACK_SKIP_ROWS,0),n.pixelStorei(n.UNPACK_ROW_LENGTH,0),n.pixelStorei(n.UNPACK_IMAGE_HEIGHT,0),n.pixelStorei(n.UNPACK_SKIP_PIXELS,0),n.pixelStorei(n.UNPACK_SKIP_ROWS,0),n.pixelStorei(n.UNPACK_SKIP_IMAGES,0),d={},f={},ee=null,ne={},u={},g=new WeakMap,m=[],x=null,p=!1,h=null,b=null,w=null,S=null,T=null,y=null,R=null,_=new Ge(0,0,0),E=0,L=!1,C=null,F=null,I=null,N=null,D=null,Ee.set(0,0,n.canvas.width,n.canvas.height),Re.set(0,0,n.canvas.width,n.canvas.height),s.reset(),a.reset(),o.reset()}return{buffers:{color:s,depth:a,stencil:o},enable:te,disable:Pe,bindFramebuffer:De,drawBuffers:Ae,useProgram:Je,setBlending:He,setMaterial:ke,setFlipSided:ct,setCullFace:ft,setLineWidth:mt,setPolygonOffset:_t,setScissorTest:nt,activeTexture:dt,bindTexture:O,unbindTexture:Tt,compressedTexImage2D:$e,compressedTexImage3D:A,texImage2D:Z,texImage3D:Q,pixelStorei:Te,getParameter:le,updateUBOMapping:we,uniformBlockBinding:Ce,texStorage2D:ie,texStorage3D:oe,texSubImage2D:v,texSubImage3D:G,compressedTexSubImage2D:W,compressedTexSubImage3D:$,scissor:ue,viewport:ce,reset:Fe}}function wf(n,e,t,i,r,s,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new qe,d=new WeakMap,f=new Set;let u;const g=new WeakMap;let m=!1;try{m=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function x(A,v){return m?new OffscreenCanvas(A,v):Wi("canvas")}function p(A,v,G){let W=1;const $=$e(A);if(($.width>G||$.height>G)&&(W=G/Math.max($.width,$.height)),W<1)if(typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&A instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&A instanceof ImageBitmap||typeof VideoFrame<"u"&&A instanceof VideoFrame){const ie=Math.floor(W*$.width),oe=Math.floor(W*$.height);u===void 0&&(u=x(ie,oe));const Z=v?x(ie,oe):u;return Z.width=ie,Z.height=oe,Z.getContext("2d").drawImage(A,0,0,ie,oe),Le("WebGLRenderer: Texture has been resized from ("+$.width+"x"+$.height+") to ("+ie+"x"+oe+")."),Z}else return"data"in A&&Le("WebGLRenderer: Image in DataTexture is too big ("+$.width+"x"+$.height+")."),A;return A}function h(A){return A.generateMipmaps}function b(A){n.generateMipmap(A)}function w(A){return A.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:A.isWebGL3DRenderTarget?n.TEXTURE_3D:A.isWebGLArrayRenderTarget||A.isCompressedArrayTexture?n.TEXTURE_2D_ARRAY:n.TEXTURE_2D}function S(A,v,G,W,$,ie=!1){if(A!==null){if(n[A]!==void 0)return n[A];Le("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+A+"'")}let oe;W&&(oe=e.get("EXT_texture_norm16"),oe||Le("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let Z=v;if(v===n.RED&&(G===n.FLOAT&&(Z=n.R32F),G===n.HALF_FLOAT&&(Z=n.R16F),G===n.UNSIGNED_BYTE&&(Z=n.R8),G===n.UNSIGNED_SHORT&&oe&&(Z=oe.R16_EXT),G===n.SHORT&&oe&&(Z=oe.R16_SNORM_EXT)),v===n.RED_INTEGER&&(G===n.UNSIGNED_BYTE&&(Z=n.R8UI),G===n.UNSIGNED_SHORT&&(Z=n.R16UI),G===n.UNSIGNED_INT&&(Z=n.R32UI),G===n.BYTE&&(Z=n.R8I),G===n.SHORT&&(Z=n.R16I),G===n.INT&&(Z=n.R32I)),v===n.RG&&(G===n.FLOAT&&(Z=n.RG32F),G===n.HALF_FLOAT&&(Z=n.RG16F),G===n.UNSIGNED_BYTE&&(Z=n.RG8),G===n.UNSIGNED_SHORT&&oe&&(Z=oe.RG16_EXT),G===n.SHORT&&oe&&(Z=oe.RG16_SNORM_EXT)),v===n.RG_INTEGER&&(G===n.UNSIGNED_BYTE&&(Z=n.RG8UI),G===n.UNSIGNED_SHORT&&(Z=n.RG16UI),G===n.UNSIGNED_INT&&(Z=n.RG32UI),G===n.BYTE&&(Z=n.RG8I),G===n.SHORT&&(Z=n.RG16I),G===n.INT&&(Z=n.RG32I)),v===n.RGB_INTEGER&&(G===n.UNSIGNED_BYTE&&(Z=n.RGB8UI),G===n.UNSIGNED_SHORT&&(Z=n.RGB16UI),G===n.UNSIGNED_INT&&(Z=n.RGB32UI),G===n.BYTE&&(Z=n.RGB8I),G===n.SHORT&&(Z=n.RGB16I),G===n.INT&&(Z=n.RGB32I)),v===n.RGBA_INTEGER&&(G===n.UNSIGNED_BYTE&&(Z=n.RGBA8UI),G===n.UNSIGNED_SHORT&&(Z=n.RGBA16UI),G===n.UNSIGNED_INT&&(Z=n.RGBA32UI),G===n.BYTE&&(Z=n.RGBA8I),G===n.SHORT&&(Z=n.RGBA16I),G===n.INT&&(Z=n.RGBA32I)),v===n.RGB&&(G===n.UNSIGNED_SHORT&&oe&&(Z=oe.RGB16_EXT),G===n.SHORT&&oe&&(Z=oe.RGB16_SNORM_EXT),G===n.UNSIGNED_INT_5_9_9_9_REV&&(Z=n.RGB9_E5),G===n.UNSIGNED_INT_10F_11F_11F_REV&&(Z=n.R11F_G11F_B10F)),v===n.RGBA){const Q=ie?ki:ze.getTransfer($);G===n.FLOAT&&(Z=n.RGBA32F),G===n.HALF_FLOAT&&(Z=n.RGBA16F),G===n.UNSIGNED_BYTE&&(Z=Q===Ke?n.SRGB8_ALPHA8:n.RGBA8),G===n.UNSIGNED_SHORT&&oe&&(Z=oe.RGBA16_EXT),G===n.SHORT&&oe&&(Z=oe.RGBA16_SNORM_EXT),G===n.UNSIGNED_SHORT_4_4_4_4&&(Z=n.RGBA4),G===n.UNSIGNED_SHORT_5_5_5_1&&(Z=n.RGB5_A1)}return(Z===n.R16F||Z===n.R32F||Z===n.RG16F||Z===n.RG32F||Z===n.RGBA16F||Z===n.RGBA32F)&&e.get("EXT_color_buffer_float"),Z}function T(A,v){let G;return A?v===null||v===1014||v===1020?G=n.DEPTH24_STENCIL8:v===1015?G=n.DEPTH32F_STENCIL8:v===1012&&(G=n.DEPTH24_STENCIL8,Le("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):v===null||v===1014||v===1020?G=n.DEPTH_COMPONENT24:v===1015?G=n.DEPTH_COMPONENT32F:v===1012&&(G=n.DEPTH_COMPONENT16),G}function y(A,v){return h(A)===!0||A.isFramebufferTexture&&A.minFilter!==1003&&A.minFilter!==1006?Math.log2(Math.max(v.width,v.height))+1:A.mipmaps!==void 0&&A.mipmaps.length>0?A.mipmaps.length:A.isCompressedTexture&&Array.isArray(A.image)?v.mipmaps.length:1}function R(A){const v=A.target;v.removeEventListener("dispose",R),E(v),v.isVideoTexture&&d.delete(v),v.isHTMLTexture&&f.delete(v)}function _(A){const v=A.target;v.removeEventListener("dispose",_),C(v)}function E(A){const v=i.get(A);if(v.__webglInit===void 0)return;const G=A.source,W=g.get(G);if(W){const $=W[v.__cacheKey];$.usedTimes--,$.usedTimes===0&&L(A),Object.keys(W).length===0&&g.delete(G)}i.remove(A)}function L(A){const v=i.get(A);n.deleteTexture(v.__webglTexture);const G=A.source,W=g.get(G);delete W[v.__cacheKey],a.memory.textures--}function C(A){const v=i.get(A);if(A.depthTexture&&(A.depthTexture.dispose(),i.remove(A.depthTexture)),A.isWebGLCubeRenderTarget)for(let W=0;W<6;W++){if(Array.isArray(v.__webglFramebuffer[W]))for(let $=0;$<v.__webglFramebuffer[W].length;$++)n.deleteFramebuffer(v.__webglFramebuffer[W][$]);else n.deleteFramebuffer(v.__webglFramebuffer[W]);v.__webglDepthbuffer&&n.deleteRenderbuffer(v.__webglDepthbuffer[W])}else{if(Array.isArray(v.__webglFramebuffer))for(let W=0;W<v.__webglFramebuffer.length;W++)n.deleteFramebuffer(v.__webglFramebuffer[W]);else n.deleteFramebuffer(v.__webglFramebuffer);if(v.__webglDepthbuffer&&n.deleteRenderbuffer(v.__webglDepthbuffer),v.__webglMultisampledFramebuffer&&n.deleteFramebuffer(v.__webglMultisampledFramebuffer),v.__webglColorRenderbuffer)for(let W=0;W<v.__webglColorRenderbuffer.length;W++)v.__webglColorRenderbuffer[W]&&n.deleteRenderbuffer(v.__webglColorRenderbuffer[W]);v.__webglDepthRenderbuffer&&n.deleteRenderbuffer(v.__webglDepthRenderbuffer)}const G=A.textures;for(let W=0,$=G.length;W<$;W++){const ie=i.get(G[W]);ie.__webglTexture&&(n.deleteTexture(ie.__webglTexture),a.memory.textures--),i.remove(G[W])}i.remove(A)}let F=0;function I(){F=0}function N(){return F}function D(A){F=A}function z(){const A=F;return A>=r.maxTextures&&Le("WebGLTextures: Trying to use "+A+" texture units while this GPU supports only "+r.maxTextures),F+=1,A}function P(A){const v=[];return v.push(A.wrapS),v.push(A.wrapT),v.push(A.wrapR||0),v.push(A.magFilter),v.push(A.minFilter),v.push(A.anisotropy),v.push(A.internalFormat),v.push(A.format),v.push(A.type),v.push(A.generateMipmaps),v.push(A.premultiplyAlpha),v.push(A.flipY),v.push(A.unpackAlignment),v.push(A.colorSpace),v.join()}function q(A,v){const G=i.get(A);if(A.isVideoTexture&&O(A),A.isRenderTargetTexture===!1&&A.isExternalTexture!==!0&&A.version>0&&G.__version!==A.version){const W=A.image;if(W===null)Le("WebGLRenderer: Texture marked for update but no image data found.");else if(W.complete===!1)Le("WebGLRenderer: Texture marked for update but image is incomplete");else{Pe(G,A,v);return}}else A.isExternalTexture&&(G.__webglTexture=A.sourceTexture?A.sourceTexture:null);t.bindTexture(n.TEXTURE_2D,G.__webglTexture,n.TEXTURE0+v)}function K(A,v){const G=i.get(A);if(A.isRenderTargetTexture===!1&&A.version>0&&G.__version!==A.version){Pe(G,A,v);return}else A.isExternalTexture&&(G.__webglTexture=A.sourceTexture?A.sourceTexture:null);t.bindTexture(n.TEXTURE_2D_ARRAY,G.__webglTexture,n.TEXTURE0+v)}function ee(A,v){const G=i.get(A);if(A.isRenderTargetTexture===!1&&A.version>0&&G.__version!==A.version){Pe(G,A,v);return}t.bindTexture(n.TEXTURE_3D,G.__webglTexture,n.TEXTURE0+v)}function ne(A,v){const G=i.get(A);if(A.isCubeDepthTexture!==!0&&A.version>0&&G.__version!==A.version){De(G,A,v);return}t.bindTexture(n.TEXTURE_CUBE_MAP,G.__webglTexture,n.TEXTURE0+v)}const se={1e3:n.REPEAT,1001:n.CLAMP_TO_EDGE,1002:n.MIRRORED_REPEAT},ge={1003:n.NEAREST,1004:n.NEAREST_MIPMAP_NEAREST,1005:n.NEAREST_MIPMAP_LINEAR,1006:n.LINEAR,1007:n.LINEAR_MIPMAP_NEAREST,1008:n.LINEAR_MIPMAP_LINEAR},Ee={512:n.NEVER,519:n.ALWAYS,513:n.LESS,515:n.LEQUAL,514:n.EQUAL,518:n.GEQUAL,516:n.GREATER,517:n.NOTEQUAL};function Re(A,v){if(v.type===1015&&e.has("OES_texture_float_linear")===!1&&(v.magFilter===1006||v.magFilter===1007||v.magFilter===1005||v.magFilter===1008||v.minFilter===1006||v.minFilter===1007||v.minFilter===1005||v.minFilter===1008)&&Le("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),n.texParameteri(A,n.TEXTURE_WRAP_S,se[v.wrapS]),n.texParameteri(A,n.TEXTURE_WRAP_T,se[v.wrapT]),(A===n.TEXTURE_3D||A===n.TEXTURE_2D_ARRAY)&&n.texParameteri(A,n.TEXTURE_WRAP_R,se[v.wrapR]),n.texParameteri(A,n.TEXTURE_MAG_FILTER,ge[v.magFilter]),n.texParameteri(A,n.TEXTURE_MIN_FILTER,ge[v.minFilter]),v.compareFunction&&(n.texParameteri(A,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(A,n.TEXTURE_COMPARE_FUNC,Ee[v.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(v.magFilter===1003||v.minFilter!==1005&&v.minFilter!==1008||v.type===1015&&e.has("OES_texture_float_linear")===!1)return;if(v.anisotropy>1||i.get(v).__currentAnisotropy){const G=e.get("EXT_texture_filter_anisotropic");n.texParameterf(A,G.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(v.anisotropy,r.getMaxAnisotropy())),i.get(v).__currentAnisotropy=v.anisotropy}}}function Y(A,v){let G=!1;A.__webglInit===void 0&&(A.__webglInit=!0,v.addEventListener("dispose",R));const W=v.source;let $=g.get(W);$===void 0&&($={},g.set(W,$));const ie=P(v);if(ie!==A.__cacheKey){$[ie]===void 0&&($[ie]={texture:n.createTexture(),usedTimes:0},a.memory.textures++,G=!0),$[ie].usedTimes++;const oe=$[A.__cacheKey];oe!==void 0&&($[A.__cacheKey].usedTimes--,oe.usedTimes===0&&L(v)),A.__cacheKey=ie,A.__webglTexture=$[ie].texture}return G}function re(A,v,G){return Math.floor(Math.floor(A/G)/v)}function te(A,v,G,W){const ie=A.updateRanges;if(ie.length===0)t.texSubImage2D(n.TEXTURE_2D,0,0,0,v.width,v.height,G,W,v.data);else{ie.sort((Te,ue)=>Te.start-ue.start);let oe=0;for(let Te=1;Te<ie.length;Te++){const ue=ie[oe],ce=ie[Te],we=ue.start+ue.count,Ce=re(ce.start,v.width,4),Fe=re(ue.start,v.width,4);ce.start<=we+1&&Ce===Fe&&re(ce.start+ce.count-1,v.width,4)===Ce?ue.count=Math.max(ue.count,ce.start+ce.count-ue.start):(++oe,ie[oe]=ce)}ie.length=oe+1;const Z=t.getParameter(n.UNPACK_ROW_LENGTH),Q=t.getParameter(n.UNPACK_SKIP_PIXELS),le=t.getParameter(n.UNPACK_SKIP_ROWS);t.pixelStorei(n.UNPACK_ROW_LENGTH,v.width);for(let Te=0,ue=ie.length;Te<ue;Te++){const ce=ie[Te],we=Math.floor(ce.start/4),Ce=Math.ceil(ce.count/4),Fe=we%v.width,U=Math.floor(we/v.width),ae=Ce,J=1;t.pixelStorei(n.UNPACK_SKIP_PIXELS,Fe),t.pixelStorei(n.UNPACK_SKIP_ROWS,U),t.texSubImage2D(n.TEXTURE_2D,0,Fe,U,ae,J,G,W,v.data)}A.clearUpdateRanges(),t.pixelStorei(n.UNPACK_ROW_LENGTH,Z),t.pixelStorei(n.UNPACK_SKIP_PIXELS,Q),t.pixelStorei(n.UNPACK_SKIP_ROWS,le)}}function Pe(A,v,G){let W=n.TEXTURE_2D;(v.isDataArrayTexture||v.isCompressedArrayTexture)&&(W=n.TEXTURE_2D_ARRAY),v.isData3DTexture&&(W=n.TEXTURE_3D);const $=Y(A,v),ie=v.source;t.bindTexture(W,A.__webglTexture,n.TEXTURE0+G);const oe=i.get(ie);if(ie.version!==oe.__version||$===!0){if(t.activeTexture(n.TEXTURE0+G),(typeof ImageBitmap<"u"&&v.image instanceof ImageBitmap)===!1){const J=ze.getPrimaries(ze.workingColorSpace),de=v.colorSpace===vn?null:ze.getPrimaries(v.colorSpace),me=v.colorSpace===vn||J===de?n.NONE:n.BROWSER_DEFAULT_WEBGL;t.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,v.flipY),t.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),t.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,me)}t.pixelStorei(n.UNPACK_ALIGNMENT,v.unpackAlignment);let Q=p(v.image,!1,r.maxTextureSize);Q=Tt(v,Q);const le=s.convert(v.format,v.colorSpace),Te=s.convert(v.type);let ue=S(v.internalFormat,le,Te,v.normalized,v.colorSpace,v.isVideoTexture);Re(W,v);let ce;const we=v.mipmaps,Ce=v.isVideoTexture!==!0,Fe=oe.__version===void 0||$===!0,U=ie.dataReady,ae=y(v,Q);if(v.isDepthTexture)ue=T(v.format===1027,v.type),Fe&&(Ce?t.texStorage2D(n.TEXTURE_2D,1,ue,Q.width,Q.height):t.texImage2D(n.TEXTURE_2D,0,ue,Q.width,Q.height,0,le,Te,null));else if(v.isDataTexture)if(we.length>0){Ce&&Fe&&t.texStorage2D(n.TEXTURE_2D,ae,ue,we[0].width,we[0].height);for(let J=0,de=we.length;J<de;J++)ce=we[J],Ce?U&&t.texSubImage2D(n.TEXTURE_2D,J,0,0,ce.width,ce.height,le,Te,ce.data):t.texImage2D(n.TEXTURE_2D,J,ue,ce.width,ce.height,0,le,Te,ce.data);v.generateMipmaps=!1}else Ce?(Fe&&t.texStorage2D(n.TEXTURE_2D,ae,ue,Q.width,Q.height),U&&te(v,Q,le,Te)):t.texImage2D(n.TEXTURE_2D,0,ue,Q.width,Q.height,0,le,Te,Q.data);else if(v.isCompressedTexture)if(v.isCompressedArrayTexture){Ce&&Fe&&t.texStorage3D(n.TEXTURE_2D_ARRAY,ae,ue,we[0].width,we[0].height,Q.depth);for(let J=0,de=we.length;J<de;J++)if(ce=we[J],v.format!==1023)if(le!==null)if(Ce){if(U)if(v.layerUpdates.size>0){const me=Ps(ce.width,ce.height,v.format,v.type);for(const j of v.layerUpdates){const Me=ce.data.subarray(j*me/ce.data.BYTES_PER_ELEMENT,(j+1)*me/ce.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,J,0,0,j,ce.width,ce.height,1,le,Me)}v.clearLayerUpdates()}else t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,J,0,0,0,ce.width,ce.height,Q.depth,le,ce.data)}else t.compressedTexImage3D(n.TEXTURE_2D_ARRAY,J,ue,ce.width,ce.height,Q.depth,0,ce.data,0,0);else Le("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ce?U&&t.texSubImage3D(n.TEXTURE_2D_ARRAY,J,0,0,0,ce.width,ce.height,Q.depth,le,Te,ce.data):t.texImage3D(n.TEXTURE_2D_ARRAY,J,ue,ce.width,ce.height,Q.depth,0,le,Te,ce.data)}else{Ce&&Fe&&t.texStorage2D(n.TEXTURE_2D,ae,ue,we[0].width,we[0].height);for(let J=0,de=we.length;J<de;J++)ce=we[J],v.format!==1023?le!==null?Ce?U&&t.compressedTexSubImage2D(n.TEXTURE_2D,J,0,0,ce.width,ce.height,le,ce.data):t.compressedTexImage2D(n.TEXTURE_2D,J,ue,ce.width,ce.height,0,ce.data):Le("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ce?U&&t.texSubImage2D(n.TEXTURE_2D,J,0,0,ce.width,ce.height,le,Te,ce.data):t.texImage2D(n.TEXTURE_2D,J,ue,ce.width,ce.height,0,le,Te,ce.data)}else if(v.isDataArrayTexture)if(Ce){if(Fe&&t.texStorage3D(n.TEXTURE_2D_ARRAY,ae,ue,Q.width,Q.height,Q.depth),U)if(v.layerUpdates.size>0){const J=Ps(Q.width,Q.height,v.format,v.type);for(const de of v.layerUpdates){const me=Q.data.subarray(de*J/Q.data.BYTES_PER_ELEMENT,(de+1)*J/Q.data.BYTES_PER_ELEMENT);t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,de,Q.width,Q.height,1,le,Te,me)}v.clearLayerUpdates()}else t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,Q.width,Q.height,Q.depth,le,Te,Q.data)}else t.texImage3D(n.TEXTURE_2D_ARRAY,0,ue,Q.width,Q.height,Q.depth,0,le,Te,Q.data);else if(v.isData3DTexture)Ce?(Fe&&t.texStorage3D(n.TEXTURE_3D,ae,ue,Q.width,Q.height,Q.depth),U&&t.texSubImage3D(n.TEXTURE_3D,0,0,0,0,Q.width,Q.height,Q.depth,le,Te,Q.data)):t.texImage3D(n.TEXTURE_3D,0,ue,Q.width,Q.height,Q.depth,0,le,Te,Q.data);else if(v.isFramebufferTexture){if(Fe)if(Ce)t.texStorage2D(n.TEXTURE_2D,ae,ue,Q.width,Q.height);else{let J=Q.width,de=Q.height;for(let me=0;me<ae;me++)t.texImage2D(n.TEXTURE_2D,me,ue,J,de,0,le,Te,null),J>>=1,de>>=1}}else if(v.isHTMLTexture){if("texElementImage2D"in n){const J=n.canvas;if(J.hasAttribute("layoutsubtree")||J.setAttribute("layoutsubtree","true"),Q.parentNode!==J){J.appendChild(Q),f.add(v),J.onpaint=de=>{const me=de.changedElements;for(const j of f)me.includes(j.image)&&(j.needsUpdate=!0)},J.requestPaint();return}if(n.texElementImage2D.length===3)n.texElementImage2D(n.TEXTURE_2D,n.RGBA8,Q);else{const me=n.RGBA,j=n.RGBA,Me=n.UNSIGNED_BYTE;n.texElementImage2D(n.TEXTURE_2D,0,me,j,Me,Q)}n.texParameteri(n.TEXTURE_2D,n.TEXTURE_MIN_FILTER,n.LINEAR),n.texParameteri(n.TEXTURE_2D,n.TEXTURE_WRAP_S,n.CLAMP_TO_EDGE),n.texParameteri(n.TEXTURE_2D,n.TEXTURE_WRAP_T,n.CLAMP_TO_EDGE)}}else if(we.length>0){if(Ce&&Fe){const J=$e(we[0]);t.texStorage2D(n.TEXTURE_2D,ae,ue,J.width,J.height)}for(let J=0,de=we.length;J<de;J++)ce=we[J],Ce?U&&t.texSubImage2D(n.TEXTURE_2D,J,0,0,le,Te,ce):t.texImage2D(n.TEXTURE_2D,J,ue,le,Te,ce);v.generateMipmaps=!1}else if(Ce){if(Fe){const J=$e(Q);t.texStorage2D(n.TEXTURE_2D,ae,ue,J.width,J.height)}U&&t.texSubImage2D(n.TEXTURE_2D,0,0,0,le,Te,Q)}else t.texImage2D(n.TEXTURE_2D,0,ue,le,Te,Q);h(v)&&b(W),oe.__version=ie.version,v.onUpdate&&v.onUpdate(v)}A.__version=v.version}function De(A,v,G){if(v.image.length!==6)return;const W=Y(A,v),$=v.source;t.bindTexture(n.TEXTURE_CUBE_MAP,A.__webglTexture,n.TEXTURE0+G);const ie=i.get($);if($.version!==ie.__version||W===!0){t.activeTexture(n.TEXTURE0+G);const oe=ze.getPrimaries(ze.workingColorSpace),Z=v.colorSpace===vn?null:ze.getPrimaries(v.colorSpace),Q=v.colorSpace===vn||oe===Z?n.NONE:n.BROWSER_DEFAULT_WEBGL;t.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,v.flipY),t.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),t.pixelStorei(n.UNPACK_ALIGNMENT,v.unpackAlignment),t.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,Q);const le=v.isCompressedTexture||v.image[0].isCompressedTexture,Te=v.image[0]&&v.image[0].isDataTexture,ue=[];for(let j=0;j<6;j++)!le&&!Te?ue[j]=p(v.image[j],!0,r.maxCubemapSize):ue[j]=Te?v.image[j].image:v.image[j],ue[j]=Tt(v,ue[j]);const ce=ue[0],we=s.convert(v.format,v.colorSpace),Ce=s.convert(v.type),Fe=S(v.internalFormat,we,Ce,v.normalized,v.colorSpace),U=v.isVideoTexture!==!0,ae=ie.__version===void 0||W===!0,J=$.dataReady;let de=y(v,ce);Re(n.TEXTURE_CUBE_MAP,v);let me;if(le){U&&ae&&t.texStorage2D(n.TEXTURE_CUBE_MAP,de,Fe,ce.width,ce.height);for(let j=0;j<6;j++){me=ue[j].mipmaps;for(let Me=0;Me<me.length;Me++){const xe=me[Me];v.format!==1023?we!==null?U?J&&t.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+j,Me,0,0,xe.width,xe.height,we,xe.data):t.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+j,Me,Fe,xe.width,xe.height,0,xe.data):Le("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):U?J&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+j,Me,0,0,xe.width,xe.height,we,Ce,xe.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+j,Me,Fe,xe.width,xe.height,0,we,Ce,xe.data)}}}else{if(me=v.mipmaps,U&&ae){me.length>0&&de++;const j=$e(ue[0]);t.texStorage2D(n.TEXTURE_CUBE_MAP,de,Fe,j.width,j.height)}for(let j=0;j<6;j++)if(Te){U?J&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,0,0,ue[j].width,ue[j].height,we,Ce,ue[j].data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,Fe,ue[j].width,ue[j].height,0,we,Ce,ue[j].data);for(let Me=0;Me<me.length;Me++){const it=me[Me].image[j].image;U?J&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+j,Me+1,0,0,it.width,it.height,we,Ce,it.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+j,Me+1,Fe,it.width,it.height,0,we,Ce,it.data)}}else{U?J&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,0,0,we,Ce,ue[j]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,Fe,we,Ce,ue[j]);for(let Me=0;Me<me.length;Me++){const xe=me[Me];U?J&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+j,Me+1,0,0,we,Ce,xe.image[j]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+j,Me+1,Fe,we,Ce,xe.image[j])}}}h(v)&&b(n.TEXTURE_CUBE_MAP),ie.__version=$.version,v.onUpdate&&v.onUpdate(v)}A.__version=v.version}function Ae(A,v,G,W,$,ie){const oe=s.convert(G.format,G.colorSpace),Z=s.convert(G.type),Q=S(G.internalFormat,oe,Z,G.normalized,G.colorSpace),le=i.get(v),Te=i.get(G);if(Te.__renderTarget=v,!le.__hasExternalTextures){const ue=Math.max(1,v.width>>ie),ce=Math.max(1,v.height>>ie);$===n.TEXTURE_3D||$===n.TEXTURE_2D_ARRAY?t.texImage3D($,ie,Q,ue,ce,v.depth,0,oe,Z,null):t.texImage2D($,ie,Q,ue,ce,0,oe,Z,null)}t.bindFramebuffer(n.FRAMEBUFFER,A),dt(v)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,W,$,Te.__webglTexture,0,nt(v)):($===n.TEXTURE_2D||$>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&$<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,W,$,Te.__webglTexture,ie),t.bindFramebuffer(n.FRAMEBUFFER,null)}function Je(A,v,G){if(n.bindRenderbuffer(n.RENDERBUFFER,A),v.depthBuffer){const W=v.depthTexture,$=W&&W.isDepthTexture?W.type:null,ie=T(v.stencilBuffer,$),oe=v.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;dt(v)?o.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,nt(v),ie,v.width,v.height):G?n.renderbufferStorageMultisample(n.RENDERBUFFER,nt(v),ie,v.width,v.height):n.renderbufferStorage(n.RENDERBUFFER,ie,v.width,v.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,oe,n.RENDERBUFFER,A)}else{const W=v.textures;for(let $=0;$<W.length;$++){const ie=W[$],oe=s.convert(ie.format,ie.colorSpace),Z=s.convert(ie.type),Q=S(ie.internalFormat,oe,Z,ie.normalized,ie.colorSpace);dt(v)?o.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,nt(v),Q,v.width,v.height):G?n.renderbufferStorageMultisample(n.RENDERBUFFER,nt(v),Q,v.width,v.height):n.renderbufferStorage(n.RENDERBUFFER,Q,v.width,v.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function Oe(A,v,G){const W=v.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(n.FRAMEBUFFER,A),!(v.depthTexture&&v.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");const $=i.get(v.depthTexture);if($.__renderTarget=v,(!$.__webglTexture||v.depthTexture.image.width!==v.width||v.depthTexture.image.height!==v.height)&&(v.depthTexture.image.width=v.width,v.depthTexture.image.height=v.height,v.depthTexture.needsUpdate=!0),W){if($.__webglInit===void 0&&($.__webglInit=!0,v.depthTexture.addEventListener("dispose",R)),$.__webglTexture===void 0){$.__webglTexture=n.createTexture(),t.bindTexture(n.TEXTURE_CUBE_MAP,$.__webglTexture),Re(n.TEXTURE_CUBE_MAP,v.depthTexture);const le=s.convert(v.depthTexture.format),Te=s.convert(v.depthTexture.type);let ue;v.depthTexture.format===1026?ue=n.DEPTH_COMPONENT24:v.depthTexture.format===1027&&(ue=n.DEPTH24_STENCIL8);for(let ce=0;ce<6;ce++)n.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,0,ue,v.width,v.height,0,le,Te,null)}}else q(v.depthTexture,0);const ie=$.__webglTexture,oe=nt(v),Z=W?n.TEXTURE_CUBE_MAP_POSITIVE_X+G:n.TEXTURE_2D,Q=v.depthTexture.format===1027?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;if(v.depthTexture.format===1026)dt(v)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,Q,Z,ie,0,oe):n.framebufferTexture2D(n.FRAMEBUFFER,Q,Z,ie,0);else if(v.depthTexture.format===1027)dt(v)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,Q,Z,ie,0,oe):n.framebufferTexture2D(n.FRAMEBUFFER,Q,Z,ie,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function Ye(A){const v=i.get(A),G=A.isWebGLCubeRenderTarget===!0;if(v.__boundDepthTexture!==A.depthTexture){const W=A.depthTexture;if(v.__depthDisposeCallback&&v.__depthDisposeCallback(),W){const $=()=>{delete v.__boundDepthTexture,delete v.__depthDisposeCallback,W.removeEventListener("dispose",$)};W.addEventListener("dispose",$),v.__depthDisposeCallback=$}v.__boundDepthTexture=W}if(A.depthTexture&&!v.__autoAllocateDepthBuffer)if(G)for(let W=0;W<6;W++)Oe(v.__webglFramebuffer[W],A,W);else{const W=A.texture.mipmaps;W&&W.length>0?Oe(v.__webglFramebuffer[0],A,0):Oe(v.__webglFramebuffer,A,0)}else if(G){v.__webglDepthbuffer=[];for(let W=0;W<6;W++)if(t.bindFramebuffer(n.FRAMEBUFFER,v.__webglFramebuffer[W]),v.__webglDepthbuffer[W]===void 0)v.__webglDepthbuffer[W]=n.createRenderbuffer(),Je(v.__webglDepthbuffer[W],A,!1);else{const $=A.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,ie=v.__webglDepthbuffer[W];n.bindRenderbuffer(n.RENDERBUFFER,ie),n.framebufferRenderbuffer(n.FRAMEBUFFER,$,n.RENDERBUFFER,ie)}}else{const W=A.texture.mipmaps;if(W&&W.length>0?t.bindFramebuffer(n.FRAMEBUFFER,v.__webglFramebuffer[0]):t.bindFramebuffer(n.FRAMEBUFFER,v.__webglFramebuffer),v.__webglDepthbuffer===void 0)v.__webglDepthbuffer=n.createRenderbuffer(),Je(v.__webglDepthbuffer,A,!1);else{const $=A.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,ie=v.__webglDepthbuffer;n.bindRenderbuffer(n.RENDERBUFFER,ie),n.framebufferRenderbuffer(n.FRAMEBUFFER,$,n.RENDERBUFFER,ie)}}t.bindFramebuffer(n.FRAMEBUFFER,null)}function He(A,v,G){const W=i.get(A);v!==void 0&&Ae(W.__webglFramebuffer,A,A.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),G!==void 0&&Ye(A)}function ke(A){const v=A.texture,G=i.get(A),W=i.get(v);A.addEventListener("dispose",_);const $=A.textures,ie=A.isWebGLCubeRenderTarget===!0,oe=$.length>1;if(oe||(W.__webglTexture===void 0&&(W.__webglTexture=n.createTexture()),W.__version=v.version,a.memory.textures++),ie){G.__webglFramebuffer=[];for(let Z=0;Z<6;Z++)if(v.mipmaps&&v.mipmaps.length>0){G.__webglFramebuffer[Z]=[];for(let Q=0;Q<v.mipmaps.length;Q++)G.__webglFramebuffer[Z][Q]=n.createFramebuffer()}else G.__webglFramebuffer[Z]=n.createFramebuffer()}else{if(v.mipmaps&&v.mipmaps.length>0){G.__webglFramebuffer=[];for(let Z=0;Z<v.mipmaps.length;Z++)G.__webglFramebuffer[Z]=n.createFramebuffer()}else G.__webglFramebuffer=n.createFramebuffer();if(oe)for(let Z=0,Q=$.length;Z<Q;Z++){const le=i.get($[Z]);le.__webglTexture===void 0&&(le.__webglTexture=n.createTexture(),a.memory.textures++)}if(A.samples>0&&dt(A)===!1){G.__webglMultisampledFramebuffer=n.createFramebuffer(),G.__webglColorRenderbuffer=[],t.bindFramebuffer(n.FRAMEBUFFER,G.__webglMultisampledFramebuffer);for(let Z=0;Z<$.length;Z++){const Q=$[Z];G.__webglColorRenderbuffer[Z]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,G.__webglColorRenderbuffer[Z]);const le=s.convert(Q.format,Q.colorSpace),Te=s.convert(Q.type),ue=S(Q.internalFormat,le,Te,Q.normalized,Q.colorSpace,A.isXRRenderTarget===!0),ce=nt(A);n.renderbufferStorageMultisample(n.RENDERBUFFER,ce,ue,A.width,A.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Z,n.RENDERBUFFER,G.__webglColorRenderbuffer[Z])}n.bindRenderbuffer(n.RENDERBUFFER,null),A.depthBuffer&&(G.__webglDepthRenderbuffer=n.createRenderbuffer(),Je(G.__webglDepthRenderbuffer,A,!0)),t.bindFramebuffer(n.FRAMEBUFFER,null)}}if(ie){t.bindTexture(n.TEXTURE_CUBE_MAP,W.__webglTexture),Re(n.TEXTURE_CUBE_MAP,v);for(let Z=0;Z<6;Z++)if(v.mipmaps&&v.mipmaps.length>0)for(let Q=0;Q<v.mipmaps.length;Q++)Ae(G.__webglFramebuffer[Z][Q],A,v,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+Z,Q);else Ae(G.__webglFramebuffer[Z],A,v,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0);h(v)&&b(n.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(oe){for(let Z=0,Q=$.length;Z<Q;Z++){const le=$[Z],Te=i.get(le);let ue=n.TEXTURE_2D;(A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(ue=A.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(ue,Te.__webglTexture),Re(ue,le),Ae(G.__webglFramebuffer,A,le,n.COLOR_ATTACHMENT0+Z,ue,0),h(le)&&b(ue)}t.unbindTexture()}else{let Z=n.TEXTURE_2D;if((A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(Z=A.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(Z,W.__webglTexture),Re(Z,v),v.mipmaps&&v.mipmaps.length>0)for(let Q=0;Q<v.mipmaps.length;Q++)Ae(G.__webglFramebuffer[Q],A,v,n.COLOR_ATTACHMENT0,Z,Q);else Ae(G.__webglFramebuffer,A,v,n.COLOR_ATTACHMENT0,Z,0);h(v)&&b(Z),t.unbindTexture()}A.depthBuffer&&Ye(A)}function ct(A){const v=A.textures;for(let G=0,W=v.length;G<W;G++){const $=v[G];if(h($)){const ie=w(A),oe=i.get($).__webglTexture;t.bindTexture(ie,oe),b(ie),t.unbindTexture()}}}const ft=[],mt=[];function _t(A){if(A.samples>0){if(dt(A)===!1){const v=A.textures,G=A.width,W=A.height;let $=n.COLOR_BUFFER_BIT;const ie=A.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,oe=i.get(A),Z=v.length>1;if(Z)for(let le=0;le<v.length;le++)t.bindFramebuffer(n.FRAMEBUFFER,oe.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+le,n.RENDERBUFFER,null),t.bindFramebuffer(n.FRAMEBUFFER,oe.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+le,n.TEXTURE_2D,null,0);t.bindFramebuffer(n.READ_FRAMEBUFFER,oe.__webglMultisampledFramebuffer);const Q=A.texture.mipmaps;Q&&Q.length>0?t.bindFramebuffer(n.DRAW_FRAMEBUFFER,oe.__webglFramebuffer[0]):t.bindFramebuffer(n.DRAW_FRAMEBUFFER,oe.__webglFramebuffer);for(let le=0;le<v.length;le++){if(A.resolveDepthBuffer&&(A.depthBuffer&&($|=n.DEPTH_BUFFER_BIT),A.stencilBuffer&&A.resolveStencilBuffer&&($|=n.STENCIL_BUFFER_BIT)),Z){n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,oe.__webglColorRenderbuffer[le]);const Te=i.get(v[le]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,Te,0)}n.blitFramebuffer(0,0,G,W,0,0,G,W,$,n.NEAREST),l===!0&&(ft.length=0,mt.length=0,ft.push(n.COLOR_ATTACHMENT0+le),A.depthBuffer&&A.resolveDepthBuffer===!1&&(ft.push(ie),mt.push(ie),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,mt)),n.invalidateFramebuffer(n.READ_FRAMEBUFFER,ft))}if(t.bindFramebuffer(n.READ_FRAMEBUFFER,null),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),Z)for(let le=0;le<v.length;le++){t.bindFramebuffer(n.FRAMEBUFFER,oe.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+le,n.RENDERBUFFER,oe.__webglColorRenderbuffer[le]);const Te=i.get(v[le]).__webglTexture;t.bindFramebuffer(n.FRAMEBUFFER,oe.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+le,n.TEXTURE_2D,Te,0)}t.bindFramebuffer(n.DRAW_FRAMEBUFFER,oe.__webglMultisampledFramebuffer)}else if(A.depthBuffer&&A.resolveDepthBuffer===!1&&l){const v=A.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[v])}}}function nt(A){return Math.min(r.maxSamples,A.samples)}function dt(A){const v=i.get(A);return A.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&v.__useRenderToTexture!==!1}function O(A){const v=a.render.frame;d.get(A)!==v&&(d.set(A,v),A.update())}function Tt(A,v){const G=A.colorSpace,W=A.format,$=A.type;return A.isCompressedTexture===!0||A.isVideoTexture===!0||G!==Hi&&G!==vn&&(ze.getTransfer(G)===Ke?(W!==1023||$!==1009)&&Le("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Xe("WebGLTextures: Unsupported texture color space:",G)),v}function $e(A){return typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement?(c.width=A.naturalWidth||A.width,c.height=A.naturalHeight||A.height):typeof VideoFrame<"u"&&A instanceof VideoFrame?(c.width=A.displayWidth,c.height=A.displayHeight):(c.width=A.width,c.height=A.height),c}this.allocateTextureUnit=z,this.resetTextureUnits=I,this.getTextureUnits=N,this.setTextureUnits=D,this.setTexture2D=q,this.setTexture2DArray=K,this.setTexture3D=ee,this.setTextureCube=ne,this.rebindTextures=He,this.setupRenderTarget=ke,this.updateRenderTargetMipmap=ct,this.updateMultisampleRenderTarget=_t,this.setupDepthRenderbuffer=Ye,this.setupFrameBufferTexture=Ae,this.useMultisampledRTT=dt,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function Rf(n,e){function t(i,r=vn){let s;const a=ze.getTransfer(r);if(i===1009)return n.UNSIGNED_BYTE;if(i===1017)return n.UNSIGNED_SHORT_4_4_4_4;if(i===1018)return n.UNSIGNED_SHORT_5_5_5_1;if(i===35902)return n.UNSIGNED_INT_5_9_9_9_REV;if(i===35899)return n.UNSIGNED_INT_10F_11F_11F_REV;if(i===1010)return n.BYTE;if(i===1011)return n.SHORT;if(i===1012)return n.UNSIGNED_SHORT;if(i===1013)return n.INT;if(i===1014)return n.UNSIGNED_INT;if(i===1015)return n.FLOAT;if(i===1016)return n.HALF_FLOAT;if(i===1021)return n.ALPHA;if(i===1022)return n.RGB;if(i===1023)return n.RGBA;if(i===1026)return n.DEPTH_COMPONENT;if(i===1027)return n.DEPTH_STENCIL;if(i===1028)return n.RED;if(i===1029)return n.RED_INTEGER;if(i===1030)return n.RG;if(i===1031)return n.RG_INTEGER;if(i===1033)return n.RGBA_INTEGER;if(i===33776||i===33777||i===33778||i===33779)if(a===Ke)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===33776)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===33777)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===33778)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===33779)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===33776)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===33777)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===33778)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===33779)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===35840||i===35841||i===35842||i===35843)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===35840)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===35841)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===35842)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===35843)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===36196||i===37492||i===37496||i===37488||i===37489||i===37490||i===37491)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(i===36196||i===37492)return a===Ke?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===37496)return a===Ke?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(i===37488)return s.COMPRESSED_R11_EAC;if(i===37489)return s.COMPRESSED_SIGNED_R11_EAC;if(i===37490)return s.COMPRESSED_RG11_EAC;if(i===37491)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===37808||i===37809||i===37810||i===37811||i===37812||i===37813||i===37814||i===37815||i===37816||i===37817||i===37818||i===37819||i===37820||i===37821)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(i===37808)return a===Ke?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===37809)return a===Ke?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===37810)return a===Ke?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===37811)return a===Ke?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===37812)return a===Ke?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===37813)return a===Ke?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===37814)return a===Ke?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===37815)return a===Ke?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===37816)return a===Ke?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===37817)return a===Ke?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===37818)return a===Ke?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===37819)return a===Ke?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===37820)return a===Ke?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===37821)return a===Ke?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===36492||i===36494||i===36495)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(i===36492)return a===Ke?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===36494)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===36495)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===36283||i===36284||i===36285||i===36286)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(i===36283)return s.COMPRESSED_RED_RGTC1_EXT;if(i===36284)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===36285)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===36286)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===1020?n.UNSIGNED_INT_24_8:n[i]!==void 0?n[i]:null}return{convert:t}}const Cf=`
void main() {
